...
and table_name = ?";
   ...
   std::string compile_column_listing() const {
...
table_schema = ? and table_name = ?";
 ...
 protected:
   ...
   std::string modify_first(Blueprint *blueprint, const std::string &column);

   //Get the SQL for an "after" column modifier.
   std::string modify_after(Blueprint *blueprint, const std::string &column);

   //Get the SQL for a "comment" column modifier.
   std::string modify_comment(Blueprint *blueprint, const std::string &column);
