...
table_schema = ? and table_name = ?";
 ...
 protected:
   ...
   std::string modify_first(Blueprint *blueprint, fluent_t &column);

   //Get the SQL for an "after" column modifier.
   std::string modify_after(Blueprint *blueprint, fluent_t &column);

   //Get the SQL for a "comment" column modifier.
   std::string modify_comment(Blueprint *blueprint, fluent_t &column);
