...
PLAIN_API int32_t 
accept(id_t id, struct sockaddr *addr, uint32_t *addrlength);
...
PLAIN_API int32_t
recvfrom(id_t id, void *buffer, int32_t length, uint32_t flag,
  struct sockaddr *from, uint32_t *fromlength);
...
PLAIN_API int32_t
getsockname(id_t id, struct sockaddr *name, int32_t *namelength);

PLAIN_API int32_t
getpeername(id_t id, struct sockaddr *name, int32_t *namelength);
